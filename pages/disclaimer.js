...
export default function Disclaimer() {
  return (
    <>
      <Head>
        <title>CBX Tracker - Disclaimer</title>
        <meta name="description" content="Read the Disclaimer for CBX Tracker’s shipment tracking services." />
      ...
      <div className="min-h-screen flex flex-col justify-between bg-cover bg-center bg-fixed" style={{ backgroundImage: "url('/background.jpg')" }}>
        ...
        <div className="flex flex-col items-center justify-center flex-grow pt-24 px-4 bg-black bg-opacity-40">
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-3xl w-full">
            ...
            <p className="text-gray-700 mb-4">This Disclaimer applies to the CBX Tracker website and its services.</p>
            ...
            <p className="text-gray-700 mb-4">CBX Logistics shall not be liable for any damages arising from the use of this site or reliance on tracking information.</p>

  ...
  return (
    <>
      <Head>
        ...
        {/* Add SEO meta tags */}
        <meta name="description" content="Track your shipments in real-time with CBX Logistics. Enter your job number or PO number to get the latest status." />
        <meta name="keywords" content="CBX Logistics, shipment tracking, job number, PO number, logistics, shipping" />
